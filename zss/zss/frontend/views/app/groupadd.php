...
<p>
 <label>描述</label>
 <span class="field"><textarea name="group_desc" id="" cols="30" rows="10"></textarea></span>
 </p> 
 <p> 
 <label>开始时间</label>
 <span class="field"><input type="text" name="group_starttime" id="datetimepicker"/></span>
 </p> 
 
 <p>
 <label>结束时间</label>
 <span class="field"><input type="text" name="group_endtime" id="datetimepicker1"/></span>
 </p> 
 <p>
 <label>轮播组名</label>
 <span class="field"><input type="text" name="group_name"/></span>
 </p> 
