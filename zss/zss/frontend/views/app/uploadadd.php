...
<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
  <p>
 <span class="field"><?= $form->field($model, 'banner_thumb')->label("图片")->fileInput() ?></span>
 </p>
 <p>
 <label>标题</label>
 <span class="field"><input type="text" name="banner_title"/></span>
 </p>                       
<p>
 <label>描述</label>
 <span class="field"><textarea name="banner_desc" id="" cols="30" rows="10"></textarea></span>
 </p> 
<p>
 <label>链接地址</label>
 <span class="field"><input type="text" name="banner_url"/></span>
 </p> 
 <p>
 <label>轮播组名</label>
