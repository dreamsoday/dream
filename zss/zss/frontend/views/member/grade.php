...
<div class="bodywrapper">
    ...
    <div class="centercontent tables">
        ...
        <div class="add" style="margin-left: 200px;">
            ...
            <p>
                <label>等级：</label>
                <span class="field"><?= $form->field($model, 'vip_name', ['inputOptions'=>['placeholder'=>'等级在五个字以内']])->label(false)->textinput(); ?></span>
            </p>
            <br />
            <p>
                <label>折扣：</label>
                <span class="field"><?= $form->field($model, 'vip_discount', ['inputOptions'=>['placeholder'=>'折扣不能大于100小于0']])->label(false)->textinput(); ?></span>
            </p>
            <br />
            <p>
                <label>满减：</label>
                <span class="field"><?= $form->field($model, 'vip_price', ['inputOptions'=>['placeholder'=>'金额在4位以内']])->label(false)->textinput(); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="field"><?= $form->field($model, 'vip_subtract', ['inputOptions'=>['placeholder'=>'金额在4位以内']])->label(false)->textinput(); ?></span>
            </p>
            <br />
            <p>
                <label>赠品：</label>
