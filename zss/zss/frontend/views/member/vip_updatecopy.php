        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                    ...
                    <?php foreach ($level as $k => $v) { ?>
                        <input type="hidden" name="vip_id" value="<?php echo $v['vip_id']?>" />
                        <p>
                            <label>等级：</label>
                            <span class="field"><input type="text" name="vip_name" class="smallinput" value="<?php echo $v['vip_name']?>" style="width:150px"/></span>
                        </p>
                        
                        <p>
                            <label>折扣：</label>
                            <span class="field"><input style="width:150px" type="text" name="vip_discount" class="mediuminput" value="<?php echo $v['vip_discount']?>"/></span>
                        </p>
                                                
                         <p>
                            <label>满减：</label>
                            <input style="width:100px" type="text" name="vip_price" class="mediuminput" value="<?php echo $v['vip_price']?>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width:100px" type="text" name="vip_subtract" class="mediuminput" value="<?php echo $v['vip_subtract']?>"/></span>
                        </p>
                        <?php }?>
                        <p>
                            <label>赠品：</label>
