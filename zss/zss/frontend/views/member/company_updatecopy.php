        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                    ...
                    <?php foreach ($company as $k => $v) { ?>
                        <input type="hidden" name="company_id" value="<?php echo $v['company_id']?>" />
                        <p>
                            <label>名称：</label>
                            <span class="field"><input type="text" name="company_name" class="smallinput" value="<?php echo $v['company_name']?>" style="width:150px"/></span>
                        </p>
                        
                        <p>
                            <label>折扣：</label>
                            <span class="field"><input style="width:150px" type="text" name="company_discount" class="mediuminput" value="<?php echo $v['company_discount']?>"/></span>
                        </p>
                                                
                         <p>
                            <label>满减：</label>
                            <input style="width:100px" type="text" name="company_price" class="mediuminput" value="<?php echo $v['company_price']?>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width:100px" type="text" name="company_subtract" class="mediuminput" value="<?php echo $v['company_subtract']?>"/></span>
                        </p>
                        <?php }?>
                        <p>
                            <label>赠品：</label>
