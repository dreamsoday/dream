    ...
    <div class="centercontent tables">
        <div id="contentwrapper" class="contentwrapper">
          ...
          <div class="contenttitle2">
                    <font size="25px">满减信息修改</font>
        </div><!--contentwrapper-->
        <div id="form" style="margin-left:50px; margin-bottom:200px;margin-top:50px;">
            <form id="form1" class="stdform" method="post" action="<?= Yii::$app->urlManager->createUrl(['marketing/subtractupdate'])?>">
            <input type="hidden" value="a429b6c0f4468db23a5661d1682db537fe2672c7" name="YII_CSRF_TOKEN" />
                <p>
                    <label>满</label>
                    <span class="field"><input type="text" value="<?php echo $subtract_list['0']['subtract_price']?>" name="subtract_price" id="firstname" class="longinput" /></span>
                </p>
            
                <p id="wallet_price">
                    <label>减</label>
                    <span class="field"><input type="text" value="<?php echo $subtract_list['0']['subtract_subtract']?>" name="subtract_subtract" id="" class="longinput" /></span>
                </p>
                <input type="hidden" name="subtract_id" value="<?php echo $subtract_id;?>" />
                <br />
