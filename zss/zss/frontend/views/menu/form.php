    ...
    <div class="centercontent">
        <div id="contentwrapper" class="contentwrapper">
        	<div id="basicform" class="subcontent">                
                    ...
                    <form class="stdform" action="<?php echo Yii::$app->urlManager->createUrl('menu/up')?>" method="post">
                        <p>
                        	<label>分类名称</label>
                            <span class="field"><input type="text" name="series_name" value="<?php echo $result['series_name']?>"/></span>
                        </p>
                        
                        <p>
                        	<label>排序</label>
                            <span class="field"><input type="text" name="series_sort" class="longinput" value="<?php echo $result['series_sort']?>"/></span>
                        </p> 
                        <p>
                        	
                            <span class="field"><input type="hidden" name="series_id" class="longinput" value="<?php echo $result['series_id']?>"/></span>
                        </p>
