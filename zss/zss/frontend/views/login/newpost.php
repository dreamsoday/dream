...
jQuery(document).ready(function(){
	...
	script_url : 'assets/js/plugins/tinymce/tiny_mce.js',
...
<div class="bodywrapper">
    <div class="topheader">
        ...
        <div class="right">
            ...
            <div class="userinfodrop">
            	<div class="avatar">
                	<img src="assets/images/thumbs/avatarbig.png" alt="" />
                </div><!--avatar-->
                <div class="userdata">
    ...
    <div class="header">
    	<ul class="headermenu">
        	<li><a href="dashboard.html"><span class="icon icon-flatscreen"></span><span>Dashboard</span></a></li>
    ...
    <div class="vernav">
    	<ul>
        	<li><a href="manageblog.html">Posts</a></li>
            <li class="current"><a href="newpost.html">Create New Post</a></li>
