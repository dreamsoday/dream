...
<div class="bodywrapper">
    ...
    <div class="centercontent tables">
        ...
        <div id="form" style="margin-left:50px; margin-bottom:200px;margin-top:50px;">
            <form id="form1" class="stdform" method="post" action="<?= Yii::$app->urlManager->createUrl(['marketing/addupdate'])?>">
            <input type="hidden" value="a429b6c0f4468db23a5661d1682db537fe2672c7" name="YII_CSRF_TOKEN" />
                <p>
                    <label>满</label>
                    <span class="field"><input type="text" value="<?php echo $add_list['0']['add_price']?>" name="add_price" id="firstname" class="longinput" /></span>
                </p>
                <p>
                    <label>赠</label>
                    <span class="field">
