...
<div class="bodywrapper">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2" style="text-align: center;">
                    ...
                    <tbody>
                        ...
                        <tr class="gradeX">
                          ...
                          <td class="center"><?php echo $v["company_id"]?></td>
                                ...
                                <td value='<?php echo $v["company_id"]?>'><a href="index.php?r=member/partnerup&company_id=<?php echo $v["company_id"]?>">修改</a> | <a href="index.php?r=member/partnerdel&company_id=<?php echo $v["company_id"]?>" class="partner_del">删除</a></td>
                        </tr>
                        <?php }?>
                    </tbody>
                </table>
    ...
    <div class="add"  style="margin-left: 400px;display: none;">
        ...
        <h3 >合作伙伴添加</h3>
            ...
            <p>
                <label>名称：</label>
                <span class="field"><input style="width:100px" type="text" name="company_name" class="mediuminput" placeholder="请输入公司名称"/></span>
            </p>
            <br />
            <p>
                <label>折扣：</label>
                <span class="field"><input style="width:150px" type="text" name="company_discount" class="mediuminput" placeholder="不能大于100小于0"/></span>
            </p>
            <br />
            <p>
                <label>满减：</label>
                <span class="field"><input style="width:100px" type="text" name="company_price" class="mediuminput" placeholder="不能大于100"/></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="field"><input style="width:100px" type="text" name="company_subtract" class="mediuminput" placeholder="不能大于100"/></span>
            </p>
            <br />
            <p>
                <label>赠品：</label>
