    ...
    <div class="centercontent tables">
        <div id="contentwrapper" class="contentwrapper">
          ...
          <div class="contenttitle2">
                    <font size="25px">折扣信息</font><button id="click" style="height:30px;width:80px">添加</button>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2" style="text-align: center;">
                    ...
                    <?php foreach($discount_list as $k=>$v){?>
                        <tr class="gradeX">
                            ...
                            <td class="center" value="<?php echo $v['discount_id']?>"><a href="?r=marketing/discountupd&&discount_id=<?php echo $v['discount_id'];?>">修改</a>
                            | <a href="?r=marketing/discountdel&&discount_id=<?php echo $v['discount_id'];?>">删除</a></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
        ...
        <div id="form" style="margin-left:50px; margin-bottom:200px;margin-top:50px;">
            <form id="form1" class="stdform" method="post" action="<?= Yii::$app->urlManager->createUrl(['marketing/discountadd'])?>">
            <input type="hidden" value="a429b6c0f4468db23a5661d1682db537fe2672c7" name="YII_CSRF_TOKEN" />
                <p>
                    <label>折扣</label>
                    <span class="field"><input type="text" name="discount_num" id="firstname" class="longinput" /></span>
                </p>
                <p>
                    <label>门店</label>
                    <span class="field">
