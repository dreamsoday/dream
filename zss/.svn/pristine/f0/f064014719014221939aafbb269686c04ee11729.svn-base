...
<form class="stdform" method="post">
    <p>
    	<label>用户名</label>
        <span class="field"><input type="text" id="adminname" name="AdminForm[admin_name]" class="smallinput"/>
    ...
    <p>
    	<label>用户手机</label>
        <span class="field"><input style="width:150px" type="text" name="AdminForm[admin_phone]" class="mediuminput"/>
    ...
    <p>
    	<label>用户邮箱</label>
        <span class="field"><input style="width:150px" type="text" name="AdminForm[admin_email]" class="mediuminput"/>
     ...
     <p>
        <label>用户密码</label>
        <span class="field"><input style="width:100px" type="text" name="AdminForm[admin_password]" class="mediuminput"/>
    ...
    <p>
        ...
        <span class="formwrapper">
            ...
            <font color='red'><?=Html::error($model,"admin_status")?></font>
        </span>
    </p>
