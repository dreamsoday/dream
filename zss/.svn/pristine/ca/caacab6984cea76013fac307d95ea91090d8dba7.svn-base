...
<div class="bodywrapper">
    ...
    <div class="vernav2 iconmenu">
    	<ul>
        	<li><a href="#formsub" class="editor">菜品管理</a>
            	<span class="arrow"></span>
            	<ul id="formsub">
               		<li><a href="<?php echo Yii::$app->urlManager->createUrl('menu/menu_type')?>">菜品分类</a></li>
                    <li><a href="<?php echo Yii::$app->urlManager->createUrl('menu/wizard')?>">菜品列表</a></li>
                </ul>
            </li>
                    ...
                    <div class="one_third last dashboard_right">
						...
						<div class="widgetbox">
                            ...
                            <div class="widgetcontent userlistwidget nopadding">
                                <ul>
                                    <li>
                                        <div class="avatar"><img alt="" src="assets/images/thumbs/avatar1.png" /></div>
                                        <div class="info">
                                            <a href="">Squint</a> <br />
                                    ...
                                    <li>
                                        <div class="avatar"><img alt="" src="assets/images/thumbs/avatar2.png" /></div>
                                        <div class="info">
                                            <a href="">Eunice</a> <br />
